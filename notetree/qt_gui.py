...
class KeywordsManager(wdg.QDialog):
    ...
    def remove_keyword(self):
        ...
        ask = wdg.QMessageBox.question(self, self.parent.base.app_title, msg)
...
class KeywordsDialog(wdg.QDialog):
    ...
    def add_trefw(self):
        ...
        """
        text, ok = wdg.QInputDialog.getText(self, self.parent.base.app_title, _('t_newtag'))
        if ok:
...
class MainWindow(wdg.QMainWindow):
    ...
    def reread(self):
        ...
        """
        dlg = wdg.QMessageBox.question(self, self.base.app_title, _("ask_reload"),
    ...
    def rename(self):
        ...
        """
        text, ok = wdg.QInputDialog.getText(self, self.base.app_title, _("t_root"),
    ...
    def new_item(self):
        ...
        text, ok = wdg.QInputDialog.getText(self, self.base.app_title, _("t_new"), text=start)
        if ok:
            item = wdg.QTreeWidgetItem()
            item.setText(0, text)
    ...
    def ask_title(self):
        ...
        """
        text, ok = wdg.QInputDialog.getText(self, self.base.app_title, _("t_name"),
    ...
    def help_page(self):
        ...
        for left, right in data:
            ...
            gbox.addWidget(wdg.QLabel(right, self), line, 1)
            line += 1
        dlg.setWindowTitle(self.base.app_title + " " + _("t_keys"))  # ' keys'
        dlg.setLayout(gbox)
        dlg.exec_()
    ...
    def choose_language(self):
        ...
        for idx, lang in enumerate([x[0] for x in data]):
            if lang == self.base.opts["Language"]:
                break
        text, ok = wdg.QInputDialog.getItem(self, self.base.app_title, _("t_lang"),
    ...
    def keyword_select(self):
        ...
        ## except ValueError:
            ## selindex = -1
        ## text, ok = wdg.QInputDialog.getItem(self, self.base.app_title,
    ...
    def text_select(self):
        ...
        if abs(seltype) != 2:
            seltext = ''
        ## text, ok = wdg.QInputDialog.getText(self, self.base.app_title,
